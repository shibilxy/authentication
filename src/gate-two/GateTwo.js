...
const GateTwo = () => {
  ...
  useEffect(() => {
    Swal({
      title: 'GATE -1 UNLOCKED',
      text: 'Enter the password to unlock Gate-2',
      icon: 'success',
  ...
  return (
    <>
      <center style={{ marginTop: '50px',  fontWeight: 'bold', fontSize: '24px' }}>
        GATE - <span style={{ color: 'green' }}>2</span>/3
      </center>
      <h5 className="blink" id="errMessage" style={{ textAlign: 'center', fontWeight: 'bold', display: 'none' }}>
        ACCESS DENIED!!
      </h5>
